...
function displayGameRewards(currentState) {
    ...
    switch(currentState) {
        ...
        case "secondReward" : {
            ...
            screen.innerHTML += "<br><br><strong>L'informajoueur : </strong>\"Un conseil ne prenez pas la confiance trop vite. Vous m'avez peut-être battu sur deux de mes jeux, mais j'ai encore une carte dans ma manche ! Un jeu où vous ne pourrez jamais, ô grand jamais me vaincre ! Dites \"adieu\" au reste de vos précieuses informations... héhéhé...\"<br><br><br><br><i>Il se frotte les mains tout en ricanant malsainement.<br><br>Cela ne vous laisse présager rien de bon...</i>";
            break;
        }
        case "thirdReward" : {
            ...
            screen.innerHTML += "<br><br><div class='gamesTextFontFamily'>Attentes professionnelles et personnelles : <br><br>J'ai un projet ambitieux, de monter ma propre société de jeux vidéos indépendants. Pour ce faire, il faut absolument que mon expérience professionnelle se fasse dans un premier temps techniquement, puis managerialement.<br><br>A court terme, je souhaite continuer de faire évoluer mes connaissances techniques dans le domaine que je côtoie aujourd'hui. A moyen terme je souhaite développer des compétences de chef de projet et de relation client. Entre ces objectifs, mon envie personnelle est de réaliser un long voyage en solitaire, pour m'obliger à sortir de mon confort, m'obliger à dépasser celui que je suis aujourd'hui et revenir en France (ou pas ?) avec une version meilleure de moi.</div>";
