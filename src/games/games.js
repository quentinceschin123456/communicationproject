...
function displayGameRewards(currentState) {
    ...
    switch(currentState) {
        ...
        case "secondReward" : {
            ...
            screen.innerHTML += "<br><br><strong>L'informajoueur : </strong>\"Un conseil ne prenez pas la confiance trop vite. Vous m'avez peut être battu sur deux de mes jeux, mais j'ai encore une carte dans ma manche ! Un jeu où vous ne pourrez jamais, oh grand jamais me vaincre ! Dites \"adieu\" au reste de vos précieuses informations... héhéhé...\"<br><br><br><br><i>Il se frotte les mains tout en ricanant malsainement.<br><br>Cela ne vous laisse présager rien de bon...</i>";
            break;
        }
        case "thirdReward" : {
