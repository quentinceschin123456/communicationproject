...
function displayGameRewards(currentState) {
    ...
    switch(currentState) {
        ...
        case "secondReward" : {
            ...
            screen.innerHTML += "<br><br><div class='gamesTextFontFamily'>Itinéraire pro-passé : <br><br>Je pense que ce qu'il est important de retenir, c'est que j'ai commencé à m'orienter dans l'informatique durant le lycée. J'ai eu la chance en Terminale Scientifique de pouvoir accéder à cette option \"Informatique et Sciecnes du Numérique\" qui m'a rendu confiant dans le fait que l'informatique ça pouvait me plaire. S'en est suivi un passage à la faculté. J'étais ainsi dans la filiaire Sciences Fondamentales Appliquées spécialité Informatique. J'ai redoublé à deux reprises ma première année pour finalement orienter ma formation vers le BTS Services Informatiques aux Organisations (SIO), avec en seconde année la spécialité Solutions Logicielles et Applications Métiers (SLAM). Ce BTS offre de nombreuses informations et permet d'approcher plusieurs domaines liés à l'informatique. Je pensais alors m'arrêter à BAC+2 ayant perdu une certaine confiance en moi lors du passage à la faculté. <br><br>Finalement j'ai été parmi le podium de la promo du BTS ce qui m'a fait envisager de continuer, au moins pour une année, mes études. Ainsi j'ai mis le cap sur une Licence Professionnelle (APSIO) en alternance. L'idée c'était de développer mon expérience professionnelle (réduite au mois de stage réalisés en BTS) tout en continuant d'étudier. Le but final étant d'avoir un diplôme BAC+3 et 1 an d'expérience pour rentrer dans la vie active.<br><br> Bon, si vous me lisez là, vous vous doutez bien de la suite... J'ai été parmi le top de la promo de la Licence Professionnelle. Et ça, ça ouvre des portes que je n'envisageais plus atteindre après la faculté. Ainsi, poussé par ma réussite, je me suis accordé le droit de penser que je pouvais avoir accès à un Master, afin de finalement réaliser un BAC+5, être \"ingénieur\" et ainsi faciliter ma vie future. Je n'avais pas beaucoup de choix à ce moment là, puisque reprendre un Master à formation continue m'aurait privé de mes ressources financières dont je dépendais. Mon dévoulu s'est donc jeté sur le Master ICE, réalisable en alternance, disponible sur Toulouse. Et je suis vraiment heureux d'avoir réalisé ce parcours pour le moins marginal. Je n'ai aucuns regrets.</div>";
            screen.innerHTML += "<br><br><div class='gamesTextFontFamily'>Incidents de parcours : <br><br>Depuis tout petit, j'use mes facilités pour réussir. Au collège j'avais de bonnes notes sans travailler. Arrivé au lycée, mes facilités n'ont plus compensé les connaissances nécessaires pour être \"bon\" scolairement parlant. J'ai sauvé mon bac de justesse et je me suis tourné automatiquement vers la faculté sans réfléchir à d'autres options. Si on remonte à mon année de Première, c'est durant les vacances de Toussaint que mon père et ma mère, jusqu'alors mariés, se sont séparés, non sans complications et violences (verbales et psychologiques). Notre père a quitté le domicile familial avant la fin des vacances, nous laissant la maison à ma mère, mon petit frère et moi. Mon frère et moi on avait une relation conflictuelle. Notre mère n'avais pas énormément d'autorité, puisque c'était notre père qui assumait ce rôle. Bref, arrivé la fin de la Terminale, je me suis litérallement enfui de là-bas. Une fois sur Toulouse, j'ai été d'abord en collocation avec des amis, puis en couple dans un appartament. C'est aussi là que j'ai compris que je ne pourrais plus avoir confiance en mon père, que je ne pourrais plus compter sur lui. Mais c'est surtout durant ces deux années de faculté que je me suis reconstruit, que j'ai gagné en maturité, que j'ai profité de cette nouvelle vie pour l'apppréhender et pour fermement la prendre en main. Je n'ai pas perdu deux ans de ma vie, c'était une passe nécessaire à mon accomplissement.</div>";
        ...
        case "thirdReward" : {
            ...
            screen.innerHTML += "<br><br><div class='gamesTextFontFamily'>Compétences professionnelles : <br><br>Je pense que mes années de formation et d'expérience m'ont apporté les compétences techniques nécessaires pour m'épanouir dans mon travail techniquement. En outre, je suis quelqu'un d'autonome, je sais m'adapter aux situations que je rencontre, je m'implique beaucoup et j'irai jusqu'à dire que j'ai un soucis du détail. Mon chef de projet m'a dit que j'apprends vite les choses, que je me les appropris vite. Je fais énormément attention à mon attitude. J'essaie de gérer les conflits au mieux, sans laisser mes émotions prendre le dessus (étant sanguin sur certains sujets c'est primordial pour éviter les conséquences fâcheuses d'actes et de paroles démesurés et peu intelligents). On est là pour faire avancer les choses intelligemment. Jusqu'à présent je réagissais mal aux changements, aux critiques, et au fait de m'ouvrir à de nouvelles choses. Je travaille aussi énormément cet aspect là pour modifier ce comportement enfantin, néfaste pour mon évolution personnelle et professionnelle. Je reste professionnel lors de mes échanges avec les autres collaborateurs, même avec ceux que je n'apprécie pas. Travailler avec des gens ne me pose aucuns soucis tant que l'honnêté prime. J'essaie d'être rapide et efficace dans mes réalisations, l'idée étant de répondre aux besoins dans le temps imparti.</div>";
            screen.innerHTML += "<br><br><div class='gamesTextFontFamily'>Attentes professionnelles et personnelles : <br><br>J'ai un projet ambitieux, de monter ma propre boite de jeux vidéos indépendants. Pour ce faire, il faut absolument que mon expérience professionnelle se fasse dans un premier temps techniquement, puis managerialement.<br><br>A court terme, je souhaite continuer de faire évoluer mes connaissances techniques dans le domaine que je cotoie aujourd'hui. A moyen terme je souhaite développer des compétences de chef de projet et de relation client. Une envie personnelle à câler au milieu sera de réaliser un long voyage seul, pour m'obliger à sortir de mon confort, m'obliger à dépasser celui que je suis aujourd'hui et revenir en France (ou pas ???) avec une version meilleure de moi.</div>";
